...
# QUO_VADIS_VERSION_CURRENT
# QUO_VADIS_VERSION_REVISION
# QUO_VADIS_VERSION_AGE
#
# COPYRIGHT
...
AC_DEFUN([AX_QUO_VADIS_LIBTOOL_VERSION], [dnl
    QUO_VADIS_VERSION_CURRENT=1
    QUO_VADIS_VERSION_REVISION=0
    QUO_VADIS_VERSION_AGE=0

    QUO_VADIS_LIBVINFO="$QUO_VADIS_VERSION_CURRENT:$QUO_VADIS_VERSION_REVISION:$QUO_VADIS_VERSION_AGE"

    AC_SUBST([QUO_VADIS_VERSION_CURRENT])
    AC_SUBST([QUO_VADIS_VERSION_REVISION])
    AC_SUBST([QUO_VADIS_VERSION_AGE])
    AC_SUBST([QUO_VADIS_LIBVINFO])

    AC_DEFINE_UNQUOTED([QUO_VADIS_VERSION_CURRENT],
                       [$QUO_VADIS_VERSION_CURRENT],
                       [Current version.])

    AC_DEFINE_UNQUOTED([QUO_VADIS_VERSION_REVISION],
                       [$QUO_VADIS_VERSION_REVISION],
                       [Current revision.])

    AC_DEFINE_UNQUOTED([QUO_VADIS_VERSION_AGE],
                       [$QUO_VADIS_VERSION_AGE],
                       [Current age.])
])
